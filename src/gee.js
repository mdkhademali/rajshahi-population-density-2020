...
// With Color Legend and Google Drive Export
// ===========================================
...
var legendTitle = ui.Label({
  ...
  style: {fontWeight: 'bold', fontSize: '14px', margin: '0 0 6px 0', color: 'black'}
});
...
for (var i = 0; i < palette.length; i++) {
  var colorBox = ui.Label({style: {backgroundColor: palette[i], padding: '10px', margin: '0 0 4px 0'}});
  var description = ui.Label({value: labels[i], style: {margin: '0 0 4px 6px'}});
...
// ===========================================
print("✅ Population density map for Rajshahi Division displayed successfully!");
print("📁 Export started — check the 'Tasks' tab to send GeoTIFF to your Google Drive.");